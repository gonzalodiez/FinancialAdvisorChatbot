...
def connect_to_db():
    ...
    db = Chroma(persist_directory="/home/gonza/gonza/Final_proyect/FinancialAdvisorChatbot/Final/chroma_full", embedding_function=embeddings, collection_name='dataset_by_chunk')
    return db
...
async def acreate_agent():
    ...
    # Define the agent
    agent = await LLMSingleActionAgent(
        llm_chain=llm_chain,
